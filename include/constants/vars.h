...
#define VAR_UNUSED_0x403F                        0x403F // UNUSED VAR: this used to be VAR_DISTRIBUTE_EON_TICKET; originally, this var was read and written, but was always zero. The only way to obtain the Eon Ticket in Emerald is via Record Mixing
