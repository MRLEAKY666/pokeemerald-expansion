...
enum
{
    ...
    OBJ_EVENT_GFX_BRENDAN_RS_NORMAL,
    OBJ_EVENT_GFX_BRENDAN_RS_ACRO_BIKE,
    OBJ_EVENT_GFX_BRENDAN_RS_MACH_BIKE,
    OBJ_EVENT_GFX_BRENDAN_RS_SURFING,
    OBJ_EVENT_GFX_BRENDAN_RS_UNDERWATER,
    OBJ_EVENT_GFX_BRENDAN_RS_FIELD_MOVE,
    OBJ_EVENT_GFX_BRENDAN_RS_FISHING,
    OBJ_EVENT_GFX_BRENDAN_RS_WATERING,
    OBJ_EVENT_GFX_BRENDAN_RS_DECORATING,
    OBJ_EVENT_GFX_MAY_RS_NORMAL,
    OBJ_EVENT_GFX_MAY_RS_ACRO_BIKE,
    OBJ_EVENT_GFX_MAY_RS_MACH_BIKE,
    OBJ_EVENT_GFX_MAY_RS_SURFING,
    OBJ_EVENT_GFX_MAY_RS_UNDERWATER,
    OBJ_EVENT_GFX_MAY_RS_FIELD_MOVE,
    OBJ_EVENT_GFX_MAY_RS_FISHING,
    OBJ_EVENT_GFX_MAY_RS_WATERING,
    OBJ_EVENT_GFX_MAY_RS_DECORATING,
    OBJ_EVENT_GFX_OLD_MAN_DISGUISE_NORMAL,
    OBJ_EVENT_GFX_OLD_MAN_DISGUISE_ACRO_BIKE,
    OBJ_EVENT_GFX_OLD_MAN_DISGUISE_MACH_BIKE,
    OBJ_EVENT_GFX_OLD_MAN_DISGUISE_SURFING,
    OBJ_EVENT_GFX_OLD_MAN_DISGUISE_UNDERWATER,
    OBJ_EVENT_GFX_OLD_MAN_DISGUISE_FIELD_MOVE,
    OBJ_EVENT_GFX_OLD_MAN_DISGUISE_FISHING,
    OBJ_EVENT_GFX_OLD_MAN_DISGUISE_WATERING,
    OBJ_EVENT_GFX_OLD_MAN_DISGUISE_DECORATING,
    OBJ_EVENT_GFX_SHIRTLESS_OLD_MAN,
