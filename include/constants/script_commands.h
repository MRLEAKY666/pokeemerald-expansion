...
enum ScrOp
{
    ...
    SCR_OP_WARPCONTINUESCRIPT = 0xCA,
    ...
    SCR_OP_BPMART = 0xE5,
    SCR_OP_WARPINPLACE = 0xE6,
    SCR_OP_TOGGLEOUTFIT = 0xE7,
    SCR_OP_GETOUTFITSTATUS = 0xE8,
    SCR_OP_BUFFEROUTFITSTR = 0xE9,
    SCR_OP_HIDEFOLLOWER = 0xEA,
    SCR_OP_GETBRAILLESTRINGWIDTH = 0xEB,
};
