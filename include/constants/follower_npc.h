...
#define FOLLOWER_NPC_FLAG_LEAVE_CLEAR_WHITEOUT  FOLLOWER_NPC_FLAG_CAN_LEAVE_ROUTE | FOLLOWER_NPC_FLAG_CLEAR_ON_WHITE_OUT
...
#define FNPC_LEAVE_WHITEOUT                   FOLLOWER_NPC_FLAG_LEAVE_CLEAR_WHITEOUT
