...
enum {
    ...
    MAPSEC_NAVEL_ROCK,
    MAPSEC_TRAINER_HILL,
    MAPSEC_DRAGONS_ROOST,
    MAPSEC_GRANITE_COVE,
    MAPSEC_FORTREE_CLIFFS,
    MAPSEC_VERDANT_PLATEAU,
    MAPSEC_MISTCLAD_COVE,
    MAPSEC_UNDERWATER_122,
    MAPSEC_UNDERWATER_GRANITE_COVE,
    MAPSEC_FLOODED_CAVERN,
    MAPSEC_LAVARIDGE_SAUNA,
    MAPSEC_LAVARBOR_TUNNEL,
    MAPSEC_CRATERED_CREST,
    MAPSEC_IMPACTED_GROTTO,
    MAPSEC_SECRET_VAULT,
    MAPSEC_SHADY_GUYS_TRUCK,
    MAPSEC_NONE,
    MAPSEC_COUNT
};
