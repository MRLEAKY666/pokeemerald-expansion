...
u16 GetPlayerAnimGraphicsIdByOutfitStateIdAndGender(u8 outfit, u8 state, enum Gender gender);
...
//void SetPlayerAvatarFishing(enum Direction direction); // this was added with fishing.c but is not needed because of outfits (i think) 
...
u8 GetLinkPlayerAvatarGraphicsIdByStateIdLinkIdAndGender(u8 state, u8 linkId, enum Gender gender);
