...
#define WE_FLAG_NO_ENCOUNTER        FLAG_OW_NO_ENCOUNTERS       // If this flag is set, wild encounters will be disabled.

// Double Wild Battles
#define WE_DOUBLE_WILD_CHANCE            25          // % chance of encountering two Pokémon in a Wild Encounter.
...
#define WE_SMART_WILD_AI_FLAG        FLAG_TEMP_SMART_WILD_AI     // If this flag is set, wild Pokémon will become smart, with all AI flags enabled.
#define WE_FLAG_NO_CATCHING          FLAG_TEMP_NO_CATCHING     // If this flag is set, the ability to catch wild Pokémon is disabled.
#define WE_FLAG_NO_RUNNING           FLAG_TEMP_NO_RUNNING     // If this flag is set, the ability to escape from wild battles is disabled. Also makes Roar/Whirlwind and Teleport (under Gen8) fail.
