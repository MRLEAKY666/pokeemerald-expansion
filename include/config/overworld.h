...
#define OW_CHOOSE_FROM_PC_AND_PARTY     FALSE       // If enabled, NPCs like move tutors or trainers asking for trade will let you pick a pokemon from your PC or party instead of just your party
...
#define OW_BERRY_DRAIN_RATE            GEN_3 // If OW_BERRY_MOISTURE is enabled, this setting changes how fast the soil dries out. GEN_4 uses a Berry-dependent drain rate, GEN_6_XY dries out in 24 hours (4 hours with the relevant Mulch) and GEN_6_ORAS dries out in 4 hours. Other values are illegal.
...
#define TIME_QUAD                       GEN_COUNT + 4
#define TIME_SEXTUPLE                   GEN_COUNT + 5
...
#define OW_ALTERED_TIME_RATIO           TIME_QUAD   // In GEN_8_PLA, the time in game moves forward 60 seconds for every second in the RTC. In GEN_9, it is 20 seconds. TIME_DEBUG is 1:1, and meant for debugging purposes. This has no effect if OW_USE_FAKE_RTC is FALSE.
...
#define OW_FLAG_NO_ENCOUNTER        FLAG_OW_NO_ENCOUNTERS  // If this flag is set, wild encounters will be disabled.
