...
static u8 CreateContestantSprite(enum Species, bool8, u32, u32, u32);
...
static u8 CreateContestantSprite(enum Species species, bool8 isShiny, u32 personality, u32 otId, u32 index)
{
    u8 spriteId;
