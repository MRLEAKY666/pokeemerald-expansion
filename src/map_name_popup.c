...
static const u8 sMapSectionToThemeId[MAPSEC_COUNT - KANTO_MAPSEC_COUNT - 1] =
{
    ...
    [MAPSEC_GRANITE_COVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_DRAGONS_ROOST - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE2,
    ...
    [MAPSEC_LAVARBOR_TUNNEL - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_CRATERED_CREST - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_IMPACTED_GROTTO - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_SECRET_VAULT - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
};
