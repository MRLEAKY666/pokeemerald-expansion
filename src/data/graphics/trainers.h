...
const u32 gTrainerFrontPic_Oak[] = INCGFX_U32("graphics/trainers/front_pics/oak.png", ".4bpp.smol");
const u16 gTrainerPalette_Oak[] = INCGFX_U16("graphics/trainers/front_pics/oak.pal", ".gbapal");

const u32 gTrainerFrontPic_OldManDisguise[] = INCGFX_U32("graphics/trainers/front_pics/old_man_disguise.png", ".4bpp.smol");
const u16 gTrainerPalette_OldManDisguise[] = INCGFX_U16("graphics/trainers/palettes/old_man_disguise.pal", ".gbapal");
...
const u8 gTrainerBackPic_OldManDisguise[] = INCGFX_U8("graphics/trainers/back_pics/old_man_disguise.png", ".4bpp");
...
const struct TrainerPicInfo gTrainerPicInfo[TRAINER_PIC_COUNT] =
{
    ...
    [TRAINER_PIC_OLD_MAN_DISGUISE] =
    {
        ...
        .backPic = TRAINER_BACK_PIC(4, gTrainerBackPic_OldManDisguise, gTrainerPalette_OldManDisguise, sBackAnims_Kanto),
    },
