...
const u32 gTrainerFrontPic_Oak[] = INCBIN_U32("graphics/trainers/front_pics/oak.4bpp.smol");
...
const u8 gTrainerBackPic_OldManDisguise[] = INCBIN_U8("graphics/trainers/back_pics/old_man_disguise.4bpp");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_FRONT_OAK, gTrainerFrontPic_Oak, gTrainerPalette_Oak),
    TRAINER_SPRITE(TRAINER_PIC_FRONT_OLD_MAN_DISGUISE, gTrainerFrontPic_OldManDisguise, gTrainerPalette_OldManDisguise),
...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(TRAINER_PIC_BACK_OLD_MAN_DISGUISE, 5, gTrainerBackPic_OldManDisguise, gTrainerPalette_OldManDisguise, sBackAnims_Kanto),
