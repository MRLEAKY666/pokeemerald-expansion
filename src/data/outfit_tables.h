...
const struct Outfit gOutfits[OUTFIT_COUNT] =
{
    ...
    [OUTFIT_GENDER_SWAPPED_STANDARD] = {
        ...
        //! (see include/constants/trainers.h)
        .trainerPics = {
            [MALE] =   {TRAINER_PIC_MAY},
            [FEMALE] = {TRAINER_PIC_BRENDAN},
        },
    ...
    [OUTFIT_GENDER_SWAPPED_RED] = {
        ...
        #endif
        .trainerPics = {
            [MALE]   = {TRAINER_PIC_RS_MAY},
            [FEMALE] = {TRAINER_PIC_RS_BRENDAN}
        },
        .avatarGfxIds = {
           [MALE] = {
               [PLAYER_AVATAR_STATE_NORMAL] =     OBJ_EVENT_GFX_MAY_RS_NORMAL,
    ...
    [OUTFIT_OLD_MAN] = {
        ...
        #endif
        .trainerPics = {
            [MALE]   = {TRAINER_PIC_OLD_MAN_DISGUISE},
            [FEMALE] = {TRAINER_PIC_OLD_MAN_DISGUISE}
        },
        .avatarGfxIds = {
           [MALE] = {
