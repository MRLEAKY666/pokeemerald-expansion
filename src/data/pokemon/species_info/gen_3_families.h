...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_CASTFORM_SANDSTORM] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "In an experiment where it was exposed to\n"
            "extreme pressures, it eventually became\n"
            "incredibly durable."),
        .pokemonScale = 435,
        .pokemonOffset = -5,
        .trainerScale = 256,
    ...
    [SPECIES_SNORUNT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 42, SPECIES_GLALIE, CONDITIONS({IF_GENDER, MON_MALE})},
                                {EVO_LEVEL, 42, SPECIES_FROSLASS, CONDITIONS({IF_GENDER, MON_FEMALE})}),
    },
    ...
    [SPECIES_LUVDISC] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_ALOMOMOLA}),
    },
