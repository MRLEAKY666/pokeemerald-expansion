...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 101 : 91)
    ...
    [SPECIES_PIKACHU] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU},
                                {EVO_ITEM, ITEM_WATER_STONE, SPECIES_RAICHU_ALOLAN}),
    },
...
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE}
    ...
    [SPECIES_EXEGGCUTE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR},
                                {EVO_SPECIFIC_MAP, MAP_FORTREE_WOODS, SPECIES_EXEGGUTOR_ALOLAN}),
    },
...
#define EXEGGUTOR_SP_DEF (P_UPDATED_STATS >= GEN_7 ? 75 : 65)
    ...
    [SPECIES_KOFFING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_CASCOON, 35, SPECIES_WEEZING},
                                {EVO_LEVEL_SILCOON, 35, SPECIES_WEEZING_GALARIAN}),
    },
