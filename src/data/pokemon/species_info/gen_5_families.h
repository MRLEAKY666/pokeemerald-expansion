...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_BISHARP] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 56, SPECIES_KINGAMBIT}),
    },
    ...
    [SPECIES_RUFFLET] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_SILCOON, 54, SPECIES_BRAVIARY},
                                {EVO_LEVEL_CASCOON, 54, SPECIES_BRAVIARY_HISUI}),
    },
