...
const u16 gMetatiles_MauvilleGameCorner_OG[] = INCBIN_U16("data/tilesets/secondary/mauville_game_corner_OG/metatiles.bin");
const u16 gMetatileAttributes_MauvilleGameCorner_OG[] = INCBIN_U16("data/tilesets/secondary/mauville_game_corner_OG/metatile_attributes.bin");
