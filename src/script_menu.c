...
static void CreateStartMenuForPokenavTutorial(void)
{
    ...
    AddTextPrinterParameterized(windowId, FONT_NORMAL, gText_MenuOptionOption, 8, 89, TEXT_SKIP_DRAW, NULL);
    AddTextPrinterParameterized(windowId, FONT_NORMAL, gText_MenuOptionExit, 8, 105, TEXT_SKIP_DRAW, NULL);
