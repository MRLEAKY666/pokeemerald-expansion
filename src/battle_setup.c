...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_WALLACE] = REMATCH(TRAINER_CHAMPION_STEVEN, TRAINER_CHAMPION_STEVEN, TRAINER_CHAMPION_STEVEN, TRAINER_CHAMPION_STEVEN, TRAINER_CHAMPION_STEVEN, EVER_GRANDE_CITY),
};
