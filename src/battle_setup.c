...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_WALLACE] = REMATCH(TRAINER_CHAMPION_STEVEN, TRAINER_CHAMPION_STEVEN, TRAINER_CHAMPION_STEVEN, TRAINER_CHAMPION_STEVEN, TRAINER_CHAMPION_STEVEN, MAP_EVER_GRANDE_CITY),
};
...
enum BattleEnvironments BattleSetup_GetEnvironmentId(void)
{
    ...
    // if (I_FISHING_ENVIRONMENT >= GEN_4 && gIsFishingEncounter) // commented this out when below 'if' line was added
