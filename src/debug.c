...
{
    { COMPOUND_STRING("Voltorb Flip"), DebugAction_ExecuteScript, Debug_EventScript_Script_1 },
    { COMPOUND_STRING("Save Game"), DebugAction_ExecuteScript, Debug_EventScript_Script_2 },
...
static const struct DebugMenuOption sDebugMenu_Actions_Flags[] =
{
    ...
    [DEBUG_FLAGVAR_MENU_ITEM_OUTFITS]              = { COMPOUND_STRING("Unlock Outfits…"),                   DebugAction_FlagsVars_Outfits },
