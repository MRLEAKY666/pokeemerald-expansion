...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_BATTLERFAINTED]                       = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} died!\p"),
    ...
    [STRINGID_MEGAEVOREACTING]                      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is reacting to its {B_LAST_ITEM}!"), //actually displays the type of mega ring in inventory, but we didnt implement them :(
    ...
    [STRINGID_AURAFLAREDTOLIFE]                     = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} is enraged!"),
    ...
    [STRINGID_CASTFORMCHANGEDWEATHER]               = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} changes the weather\nwith {B_CURRENT_MOVE}."),
    ...
    [STRINGID_QUESTIONFORFEITBATTLE]                = COMPOUND_STRING("Forfeiting the battle is the same as losing the battle.\pWould you like to forfeit this battle?"),
...
const u8 gText_BattleMenuForfeit[] = _("Battle{CLEAR_TO 56}Bag\nPokémon{CLEAR_TO 56}Forfeit");
