...
#define GACHA_BASIC_MIN_WAGER 1000
#define GACHA_GREAT_MIN_WAGER 2500
#define GACHA_ULTRA_MIN_WAGER 5000
#define GACHA_MASTER_MIN_WAGER 7500
...
static const SpeciesGacha sSpeciesUltraUltraRare[] = {
    ...
    {11, SPECIES_MURKROW},
    {12, SPECIES_ABSOL},
    {13, SPECIES_WARTORTLE},
    {14, SPECIES_CROCONAW},
    {15, SPECIES_GROVYLE},
    {16, SPECIES_COMBUSKEN},
    {17, SPECIES_MARSHTOMP},
    {18, SPECIES_CHARMELEON},
    {19, SPECIES_QUILAVA},
    {20, SPECIES_LAPRAS},
    {21, SPECIES_MUNCHLAX},
    {22, SPECIES_GROWLITHE},
    {23, SPECIES_DRAGONAIR},
    {24, SPECIES_PUPITAR},
    {25, SPECIES_NOIBAT},
    {26, SPECIES_PURRLOIN},
    {27, SPECIES_VIGOROTH}
...
static const SpeciesGacha sSpeciesMasterCommon[] = {
    ...
    {9, SPECIES_DARUMAKA},
    {10, SPECIES_BAYLEEF},
    {11, SPECIES_WARTORTLE},
    {12, SPECIES_CROCONAW},
    {13, SPECIES_GROVYLE},
    {14, SPECIES_COMBUSKEN},
    {15, SPECIES_MARSHTOMP},
    {16, SPECIES_CHARMELEON},
    {17, SPECIES_QUILAVA}
};
...
static const SpeciesGacha sSpeciesMasterRare[] = {
    {0, SPECIES_LARVESTA},
    {1, SPECIES_ZORUA},
    {2, SPECIES_ZORUA_HISUI},
    {3, SPECIES_BASCULIN_WHITE_STRIPED},
    {4, SPECIES_APPLIN},
    {5, SPECIES_FEEBAS},
    {6, SPECIES_ARCHEN},
    {7, SPECIES_SIGILYPH},
...
static void GachaMain(u8 taskId)
{
    ...
    case STATE_POKEBALL_ARRIVE_WAIT:        
        ...
        {
            CreateMon(&gParties[B_TRAINER_OPPONENT_A][0], sGacha->CalculatedSpecies, level, Random32(), OTID_STRUCT_PLAYER_ID);
            GiveCapturedMonToPlayer(&gParties[B_TRAINER_OPPONENT_A][0]);
